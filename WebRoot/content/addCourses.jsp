    	...
    	<div>
    		<form class="form-group" action="<%=request.getContextPath() %>/servlet/CoursesServlet" method="post" role="form">
				...
				<div class="form form-inline">
					...
					<input id="empName" class="form-control" type="text" name="course_name" autofocus="autofocus" placeholder="请输入课程名称" autocomplete="off" maxlength="20" required="required"/>
				</div>
				<div class="form form-group">
					<a href="<%=request.getContextPath() %>/servlet/CoursesServlet?operation=select&curPage=1" class="btn btn-primary">取消</a>
