    	...
    	<div>
    		<form class="form-group" action="<%=request.getContextPath() %>/servlet/StudentServlet" method="post" role="form">
				...
				<div class="form form-inline">
					...
					<input id="empName" class="form-control" type="text" name="id" autofocus="autofocus" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
				</div>
				 -->
				<div class="form form-inline">
					<label for="empName">姓名:</label>
					<input id="empName" class="form-control" type="text" name="name" autofocus="autofocus"  maxlength="6" autocomplete="off" required="required" placeholder="请输入姓名"/>
				</div>
				<div class="form form-inline">
				...
				<div class="form form-inline">
					...
					<input id="title" class="form-control" placeholder="请输入年龄" type="text" name="age" autofocus="autofocus" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
				</div>
				<div class="form form-inline">
				...
				<div class="form form-group">
					<a href="<%=request.getContextPath() %>/servlet/StudentServlet?operation=select&curPage=1" class="btn btn-primary">取消</a>
